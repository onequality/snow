...
/* harmony import */ var _C_damigroupinc_com_customers_onequality_oneqservices_snow_node_modules_ngtools_webpack_src_loaders_direct_resource_js_explore_container_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./explore-container.component.html */ 9651);
...
ExploreContainerComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Component)({
        ...
        template: _C_damigroupinc_com_customers_onequality_oneqservices_snow_node_modules_ngtools_webpack_src_loaders_direct_resource_js_explore_container_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
let GlobalService = class GlobalService {
    constructor(http, router, toastController) {
        this.http = http;
        this.router = router;
        this.toastController = toastController;
        this.urlServer = 'http://oneqservices.com/api/';
        this.urlServerJSON = "assets/langs/";
        this.version = '1.0-Snow1Q-IPhone';
        this.name = 'oneqservices.com';
        this.company = 'One Quality Inc';
        this.published = '01/06/2022 15:00 PM US';
        this.website = 'oneqservices.com';
        this.developer = "Dami Group Inc";
        this.copyright = "OneQ and Snow1Q is trademark of the One Quality Inc";
        this.photo = '';
        this.language = 'enus';
    }
    presentToastGeneric(strMsg, strColor) {
        if (strColor == 'Red') {
    ...
    showToastSuccess(strTipo, strMsg) {
    ...
    showToastWarning(strTipo, strMsg) {
        this.toastController.create({
            header: strTipo,
            message: strMsg,
            position: 'bottom',
